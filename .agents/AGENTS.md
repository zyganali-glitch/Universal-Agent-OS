...
2. **Supreme Binding**: You MUST automatically read en/AGENTS.md (or tr/AGENTS.md). That file is the supreme constitution of this repository. You are strictly bound by ALL of its rules, gates, and constraints (Tech-Debt Delta = 0, No-UI-Regression, etc.) for the entire duration of your session, not just Phase-0.
